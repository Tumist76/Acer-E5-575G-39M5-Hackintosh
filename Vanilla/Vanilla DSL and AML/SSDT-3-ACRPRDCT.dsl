 ...
 *
 * Disassembly of SSDT-3-ACRPRDCT.aml, Sat Sep  1 22:39:05 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00003016 (12310)
 *     Revision         0x01
 *     Checksum         0x57
 *     OEM ID           "ACRSYS"
...
DefinitionBlock ("", "SSDT", 1, "ACRSYS", "ACRPRDCT", 0x00001000)
{
    ...
    {
        OperationRegion (VBOR, SystemMemory, 0xA7F03018, 0x00040004)
    ...
    Scope (\_SB.PCI0.RP01.PXSX)
    {
        OperationRegion (SGOP, SystemMemory, 0xA7D7DF98, 0x00000045)
    ...
    Scope (\_SB.PCI0.RP01.PXSX)
    {
        OperationRegion (NOPR, SystemMemory, 0xA7F7A018, 0x00002010)
